...
const ACT_SYM={red:"!",gold:"â—†",blue:"â‡¢",client:"â—‘",grn:"âœ“"};
...
function blankData(name){return {meta:{company:"YOUR LOGO",title:"Account Status Report",client:name||"New Client",accountManager:"Trading Desk",period:"",issued:"",reportNo:"",tradeLane:"China â†’ Brazil (BR)",preparedBy:"Trading Desk",contact:"desk@company.com"},kpi:{activeFoot:"vs. last month",transitFoot:"upcoming arrivals"},pos:[],neg:[],act:[],closed:[]};}
function ventoSul(){const d=blankData("Vento Sul ImportaÃ§Ã£o Ltda.");d.meta.accountManager="F. â€” Trading Desk";d.meta.period="July 2026";d.meta.issued="05 Aug 2026";d.meta.reportNo="VSÂ·ASRÂ·2026-07";d.kpi.activeFoot="â–² 2 vs. Jun";d.kpi.transitFoot="next ETA 19 Aug Â· ParanaguÃ¡";
  d.pos=[
    ...
    {id:uid(),code:"PO-2026-0149",ndr:"NDR-2602",product:"Cornstarch clamshells",qty:"2Ã—40â€²HC",value:71200,incoterm:"FOB Shenzhen",prod:60,insp:"Booked",inspDate:"22 Aug",cargoReady:"30 Aug",eta:"05 Oct",port:"Santos",stage:"In Production"},
    {id:uid(),code:"PO-2026-0148",ndr:"NDR-2603",product:"Bamboo stirrers",qty:"6.0M pcs",value:75000,incoterm:"FOB Ningbo",prod:80,insp:"Booked",inspDate:"18 Aug",cargoReady:"26 Aug",eta:"01 Oct",port:"ParanaguÃ¡",stage:"In Production"},
    ...
    {id:uid(),code:"PO-2026-0145",ndr:"NDR-2605",product:"Kraft food boxes",qty:"2Ã—40â€²HC",value:88400,incoterm:"FOB Qingdao",prod:100,insp:"Passed",inspDate:"",cargoReady:"Ready 06 Aug",eta:"12 Sep",port:"ItajaÃ­",stage:"Cargo Ready"},
    {id:uid(),code:"PO-2026-0144",ndr:"NDR-2606",product:"Sugarcane bowls",qty:"1Ã—40â€²HC",value:46700,incoterm:"FOB Qingdao",prod:100,insp:"Passed",inspDate:"",cargoReady:"Booked 05 Aug",eta:"10 Sep",port:"Santos",stage:"Booked"},
    {id:uid(),code:"PO-2026-0143",ndr:"NDR-2607",product:"PLA cutlery sets",qty:"1Ã—40â€²HC",value:52300,incoterm:"FOB Shenzhen",prod:100,insp:"Passed",inspDate:"",cargoReady:"Loaded 02 Aug",eta:"08 Sep",port:"Santos",stage:"Loaded"},
    ...
    {id:uid(),code:"PO-2026-0140",ndr:"NDR-2609",product:"Bagasse plates",qty:"30 CBM",value:63700,incoterm:"FOB Qingdao",prod:100,insp:"Passed",inspDate:"",cargoReady:"ETD 14 Jul",eta:"19 Aug",port:"ParanaguÃ¡",stage:"In Transit"}
  ];
  d.neg=[
    {id:uid(),ref:"NEG-04",topic:"Kraft mailer boxes â€” new SKU",next:"send FOB quote",owner:"Desk",due:"08 Aug",value:120000,stage:"Inquiry",outcome:"Open",samples:"Pending"},
    {id:uid(),ref:"NEG-03",topic:"Cornstarch cutlery â€” volume tier",next:"align target price",owner:"Client",due:"11 Aug",value:260000,stage:"Proposal",outcome:"Open",samples:"Approved"},
    {id:uid(),ref:"NEG-02",topic:"Bamboo stirrers â€” H2 re-price",next:"counter w/ 2 factories",owner:"Desk",due:"07 Aug",value:150000,stage:"Proposal",outcome:"Open",samples:"Delivered"},
    ...
    {id:uid(),ref:"NEG-99",topic:"Sugarcane trays â€” spot deal",next:"â€” converted to PO-0144",owner:"Desk",due:"â€”",value:46700,stage:"Proposal",outcome:"Won",samples:"Approved",wonPo:"seeded"},
    {id:uid(),ref:"NEG-98",topic:"Wooden forks â€” bulk trial",next:"â€” price not competitive",owner:"Desk",due:"â€”",value:60000,stage:"Inquiry",outcome:"Lost",samples:"Rejected"}
  ];
  d.act=[
    {id:uid(),type:"red",text:"PO-0146 â€” QC window is tight. Confirm inspection booking by 08 Aug to protect 15 Aug cargo-ready date.",owner:"Trading Desk"},
    {id:uid(),type:"client",text:"PO-0145 â€” cargo ready 06 Aug. Awaiting booking confirmation & shipping instructions from client.",owner:"Client"},
    {id:uid(),type:"blue",text:"PO-0143 â€” loaded 02 Aug; vessel booked, ETD confirmed 08 Sep to Santos.",owner:"Trading Desk"},
    {id:uid(),type:"gold",text:"PO-0151 â€” deposit received 01 Aug; production start pending material colour approval.",owner:"Factory / Client"},
    {id:uid(),type:"grn",text:"NEG-01 â€” client requested payment-terms review (30/70 â†’ LC at sight) before signing.",owner:"Trading Desk"}
  ];
  d.closed=[
    {id:uid(),code:"PO-2026-0138",ndr:"NDR-2588",product:"Bagasse bowls",value:58900,delivered:"28 Jul",port:"Santos"},
    {id:uid(),code:"PO-2026-0135",ndr:"NDR-2585",product:"Paper cups 16oz",value:84300,delivered:"15 Jul",port:"ItajaÃ­"}
  ];return d;}
function andes(){const d=blankData("Andes ImportaÃ§Ãµes S.A.");d.meta.period="July 2026";d.meta.issued="05 Aug 2026";d.meta.reportNo="ANDÂ·ASRÂ·2026-07";d.meta.tradeLane="China â†’ Chile (CL)";
  d.pos=[
    {id:uid(),code:"PO-2026-0207",ndr:"NDR-2610",product:"PET clamshells",qty:"2Ã—40â€²HC",value:64800,incoterm:"FOB Ningbo",prod:35,insp:"Pending",inspDate:"",cargoReady:"20 Sep",eta:"28 Oct",port:"San Antonio",stage:"In Production"},
    {id:uid(),code:"PO-2026-0205",ndr:"NDR-2611",product:"Aluminium foil trays",qty:"1Ã—40â€²HC",value:47500,incoterm:"FOB Qingdao",prod:100,insp:"Passed",inspDate:"",cargoReady:"Loaded 03 Aug",eta:"09 Sep",port:"San Antonio",stage:"Loaded"}
  ];
  d.neg=[{id:uid(),ref:"NEG-11",topic:"Compostable cups â€” trial order",next:"send samples",owner:"Desk",due:"12 Aug",value:90000,stage:"Inquiry",outcome:"Open",samples:"Requested"}];
  d.closed=[{id:uid(),code:"PO-2026-0198",ndr:"NDR-2580",product:"Kraft bags",value:39900,delivered:"22 Jul",port:"ValparaÃ­so"}];return d;}
...
function renderReport(){if(reportMode==="all"){renderConsolidated();return;}
  ...
  const opsRows=data.pos.map(p=>`<tr>
    <td class="po">${p.code?esc(p.code):'<span class="addpo">add PO#</span>'}</td><td class="ndr">${esc(p.ndr||"â€”")}</td>
    ...
    <td class="ic">${esc(p.cargoReady)}</td><td>${inspCell(p)}</td><td class="ic">${esc(p.eta)} Â· ${esc(p.port)}</td>
  ...
  const actRows=data.act.map(a=>`<div class="act-row"><div class="tag t-${a.type}">${ACT_SYM[a.type]||"â—†"}</div><div>${boldCodes(a.text)} <span class="who">Owner: ${esc(a.owner)}</span></div></div>`).join("");
  ...
  <div class="sheet">
    ...
    <div class="sec-h"><span class="n">01</span><h3>Deal Journey â€” Live Position</h3><span class="rule"></span><span class="aside">Each reference plotted at its current lifecycle stage</span></div>
    ...
    <div class="sec-h"><span class="n">02</span><h3>Confirmed Orders &amp; Operations</h3><span class="rule"></span><span class="aside">${data.pos.length} active Â· US$ ${money(openVal)}</span></div>
    ...
    <div class="sec-h"><span class="n">03</span><h3>Commercial Pipeline</h3><span class="rule"></span><span class="aside">${openNegs.length} open Â· US$ ${money(negVal)}</span></div>
    ...
    <footer class="r-foot"><div class="conf">Confidential â€” prepared exclusively for ${esc(m.client)}</div><div class="who">Prepared by <b>${esc(m.preparedBy)}</b> Â· ${esc(m.contact)}</div></footer>
  </div>`;
  fitReport();
}
...
function renderConsolidated(){
  ...
  const opsRows=POS.map(x=>{const p=x[0],c=x[1];return `<tr>
    ...
    <td class="ic">${esc(p.eta)}${p.port?" Â· "+esc(p.port):""}</td><td><span class="pill ${pillClass(p.stage)}">${esc(p.stage)}</span></td></tr>`;}).join("");
  ...
  const actRows=ACT.map(x=>{const a=x[0],c=x[1];return `<div class="act-row"><div class="tag t-${a.type}">${ACT_SYM[a.type]||"â—†"}</div><div><span class="ccode" style="background:${c.color};margin-right:5px">${esc(c.code)}</span>${boldCodes(a.text)} <span class="who">Owner: ${esc(a.owner)}</span></div></div>`;}).join("");
  const actLegend=ACT_TYPES.map(t=>`<span class="l"><i class="t-${t[0]}"></i> ${t[1]}</span>`).join("");
  ...
  document.getElementById("reportRoot").innerHTML=`
  <div class="sheet">
    <header class="r-masthead"><div class="brand">${markHtml}<div class="brand-txt"><div class="eyebrow">Portfolio Intelligence</div><h2>Consolidated Business Overview</h2><div class="sub">All clients â€” commercial &amp; operational tracking</div></div></div>
      <dl class="meta"><dt>Scope</dt><dd>All clients (${cs.length})</dd><dt>Account Manager</dt><dd>Trading Desk</dd><dt>Snapshot</dt><dd class="accent">${today}</dd><dt>Report No.</dt><dd class="mono">PORTFOLIO</dd><dt>Trade Lanes</dt><dd>China â†’ LATAM</dd></dl></header>
    <section class="kpis">${kpisHtml}</section>
    <div class="roster"><span class="rlab">Clients included</span>${roster}</div>
    <div class="sec-h"><span class="n">01</span><h3>Deal Journey â€” All Clients</h3><span class="rule"></span><span class="aside">Every live reference across the portfolio Â· dot colour = client</span></div>
    <section class="journey"><div class="stops" style="grid-template-columns:repeat(${STOPS.length},1fr)">${stopsHtml}</div><div class="journey-legend"><span class="lg"><i style="background:#D9B24A"></i> Commercial / factory</span><span class="lg"><i style="background:#3C5C7A"></i> Logistics</span><span class="lg"><i style="background:#2E7D57"></i> Closed</span></div></section>
    <div class="sec-h"><span class="n">02</span><h3>Confirmed Orders &amp; Operations â€” All Clients</h3><span class="rule"></span><span class="aside">${POS.length} active Â· US$ ${money(openVal)}</span></div>
    ...
    <div class="sec-h"><span class="n">03</span><h3>Commercial Pipeline â€” All Clients</h3><span class="rule"></span><span class="aside">${NEG.length} open Â· US$ ${money(negVal)}</span></div>
    ...
    <div class="sec-h"><span class="n">04</span><h3>Action Items &amp; Alerts â€” All Clients</h3><span class="rule"></span></div>
    ...
    <div class="sec-h"><span class="n">05</span><h3>Business Forecast</h3><span class="rule"></span><span class="aside">Projected revenue Â· US$ ${money(tP)}</span></div>
    ...
    <div class="fcnote">Weighted pipeline applies close-probabilities by stage â€” Inquiry 25% Â· Proposal 70% (Won deals already sit in the order book). Projected = realised + order book + weighted pipeline. Indicative planning figure, not a commitment.</div>
    <footer class="r-foot"><div class="conf">Confidential â€” internal business overview Â· all clients</div><div class="who">Prepared by <b>Trading Desk</b> Â· ${today}</div></footer>
  </div>`;
  fitReport();
}
...
function renderManage(){
  document.getElementById("list-pos").innerHTML=data.pos.map((p,i)=>{const dateF=p.insp==="Booked"?field("pos",p.id,"inspDate","Inspection booked date",p.inspDate):"";
    return `<div class="mcard"><div class="ttl"><span class="idx">${i+1}</span><span class="name">${esc(p.code||"Draft PO â€” add number")}</span><div class="ttl-actions"><button class="deliver" data-deliver="${p.id}">âœ“ Mark delivered</button><button class="del" data-del="pos" data-id="${p.id}">Delete</button></div></div>
...
function renderSettings(){const m=data.meta,k=data.kpi;const dm=(store.settings&&store.settings.deliveredMode)||"Hidden";
  ...
  document.getElementById("list-settings").innerHTML=`
    <div class="mcard"><div class="ttl"><span class="idx">Â§</span><span class="name">Report header</span></div>
    ...
    <div class="mcard"><div class="ttl"><span class="idx">â—†</span><span class="name">Logo image <span style="font-weight:400;color:var(--muted);font-size:11px">(applies to all clients &amp; the consolidated report)</span></span></div>
      <div class="logobox"><div class="logopreview">${logoPrev}</div><div><button class="add-btn" data-action="logo-upload" style="padding:9px 16px;width:auto">â†¥ Upload logo image</button>${store.logo?`<button class="add-btn" data-action="logo-remove" style="padding:9px 16px;width:auto;margin-top:8px;border-color:#e6c9c4;color:var(--act)">Remove logo</button>`:""}<div class="hint">PNG/JPG. Auto-resized and framed inside the header mark.</div></div></div></div>
    <div class="mcard"><div class="ttl"><span class="idx">â†¦</span><span class="name">Deal Journey â€” delivered deals <span style="font-weight:400;color:var(--muted);font-size:11px">(applies to all clients)</span></span></div>
      ...
      <div class="hint"><b>Hidden</b> â€” delivered deals drop off the journey. <b>Count</b> â€” a single "N closed" tag. <b>Listed</b> â€” every delivered PO plotted.</div></div>
    <div class="mcard"><div class="ttl"><span class="idx">%</span><span class="name">KPI footnotes</span></div>
      <div class="grid">${field("kpi","_","activeFoot","Active POs â€” footnote",k.activeFoot)}${field("kpi","_","transitFoot","In Transit â€” footnote",k.transitFoot)}</div></div>
    <div class="mcard"><div class="ttl"><span class="idx">âŸ²</span><span class="name">Data</span></div>
      <div class="grid"><div class="f"><label>&nbsp;</label><button class="add-btn" data-action="export" style="padding:9px">â†§ Backup (download JSON)</button></div><div class="f"><label>&nbsp;</label><button class="add-btn" data-action="import" style="padding:9px">â†¥ Import (restore JSON)</button></div><div class="f"><label>&nbsp;</label><button class="add-btn" data-action="reset" style="padding:9px;border-color:#e6c9c4;color:var(--act)">â†º Reset to sample data</button></div></div>
      <div class="datalegend"><h4>How to manage your data â€” the three buttons</h4>
        <div class="dlrow"><span class="dlk b1">â†§ Backup</span><div><b>Saves everything to one file.</b> Downloads a single JSON with <b>all clients</b> â€” your master register. Keep it in your drive and back up after each session.</div></div>
        <div class="dlrow"><span class="dlk b2">â†¥ Import</span><div><b>Loads a backup file back in.</b> <b>Replaces</b> everything in the tool. Use it to restore, or to move to another device or browser.</div></div>
        <div class="dlrow"><span class="dlk b3">â†º Reset</span><div><b>Wipes everything and reloads the sample</b> â€” <b>back up first</b>, current entries can't be recovered.</div></div>
      </div></div>`;
}
...
main.addEventListener("change",e=>{const t=e.target;if(!t.dataset.entity||t.tagName!=="SELECT")return;setField(t.dataset.entity,t.dataset.id,t.dataset.field,t.value);renderReport();renderManage();save();
  if(pendingWonAlert){const r=pendingWonAlert;pendingWonAlert=null;setTimeout(()=>alert('"'+r+'" marked Won.\n\nA draft PO was created in Purchase Orders (value & product pre-filled) â€” open it to add the PO number and remaining details.'),40);}});
...
function addItem(kind){
  if(kind==="pos")data.pos.push({id:uid(),code:"PO-2026-0000",ndr:"",product:"New product",qty:"1Ã—40â€²HC",value:0,incoterm:"FOB Qingdao",prod:0,insp:"Pending",inspDate:"",cargoReady:"TBD",eta:"TBD",port:"Santos",stage:"Confirmed"});
